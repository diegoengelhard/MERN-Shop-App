...
// GET Get latest 5 orders (only admin)
router.get('/latest', authenticate, authorize, controller.getLatest);

// GET income stats
router.get('/income', authenticate, authorize, controller.getIncome);
